...
public class DialogueManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        continueButton.onClick.AddListener(ContinueDialogue); // Set up the button listener
    ...
    void ShowInstructions()
    {
        ...
        // Ensure the continueButton is not being used elsewhere
        continueButton.onClick.RemoveAllListeners(); // Remove previous listeners
        continueButton.onClick.AddListener(LoadSpaceCrushScene); // Add new listener to load the scene
        continueButton.gameObject.SetActive(true); // Show the continue button

        Debug.Log("Instructions shown. Continue button should now load the scene.");
    }

    public void LoadSpaceCrushScene()
    {
        // Log to ensure this method is called
        Debug.Log("LoadSpaceCrushScene method called.");
        
        // Load the Space_Crush scene
        SceneManager.LoadScene("Space_Crush");
    }
